<?php
/**
* Franchisee Domain Model
* All domains
*/

class Franchisee_domain_model extends MY_Model
{
    ...
    */
    public function franchisee_domain_load($condition,$limit=NULL,$offset=NULL,$order_by=NULL)
    {
        $rs=new stdClass();
        if(is_integer($condition))
        {
            $this->db->join("admin a","a.id=fd.aid","left");//left join
            $this->db->select('fd.*,a.admin_type_id, a.s_admin_name');
            
            $rs=$this->db
                ->get_where("franchisee_domain fd",
        ...
        else
        {
            ...
            */
            $this->db->start_cache();
                ...
                $this->db->from("franchisee_domain fd");
            $this->db->stop_cache();
    ...
    */
    public function add_franchisee_domain($values)
    {
        return $this->add_("franchisee_domain",$values);
    }
    ...
    */
    public function update_franchisee_domain($values,$where)
    {
        return $this->update_("franchisee_domain",$values,$where);
    }    
    ...
    *                       "name='Joe' AND status='boss' OR status='active'";
    */
    public function delete_franchisee_domain($where)
    {
        return $this->delete_("franchisee_domain",$where);
    }    
