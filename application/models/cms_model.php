...
class Cms_model extends MY_Model
{
    ...
    */
    public function cms_load($condition,$limit=NULL,$offset=NULL,$order_by=NULL)
    {
        return $this->load_("cms",$condition,$limit,$offset,$order_by);
    }
    ...
    */
    public function add_cms($values)
    {
        return $this->add_("cms",$values);
    }
    ...
    */
    public function update_cms($values,$where)
    {
        return $this->update_("cms",$values,$where);
    }    
    ...
    *                       "name='Joe' AND status='boss' OR status='active'";
    */
    public function delete_cms($where)
    {
        return $this->delete_("cms",$where);
    }    
