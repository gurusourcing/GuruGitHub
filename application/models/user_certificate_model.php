<?php
/**
* user certificate fields Model
* 
*/

class User_certificate_model extends MY_Model
{
    ...
    */
    public function user_certificate_load($condition,$limit=NULL,$offset=NULL,$order_by=NULL)
    { $rs=new stdClass();
        if(is_integer($condition))
        {
            $this->db->join("users u","u.id=uc.uid","left");//left join
            $this->db->select('uc.*,u.s_user_name');
            
            $rs=$this->db
                ->get_where("user_certificate uc",
        ...
        else
        {
            ...
            */
            $this->db->start_cache();
                ...
                $this->db->from("user_certificate uc");
            $this->db->stop_cache();
    ...
    */
    public function add_user_certificate($values)
    {
        return $this->add_("user_certificate",$values);
    }
    ...
    */
    public function update_user_certificate($values,$where)
    {
        return $this->update_("user_certificate",$values,$where);
    } 
    ...
    *                       "name='Joe' AND status='boss' OR status='active'";
    */
    public function delete_user_certificate($where)
    {
        return $this->delete_("user_certificate",$where);
    }    
