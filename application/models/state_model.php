...
class State_model extends MY_Model
{
    ...
    */
    ...
    public function state_load($condition,$limit=NULL,$offset=NULL,$order_by=NULL)
    {
        $rs=new stdClass();
        if(is_integer($condition))
        {
            $this->db->join("country c","c.id=s.country_id","left");//left join
            $this->db->select('s.*,c.s_country');
    ...
    */
    public function add_state($values)
    {
        return $this->add_("state",$values);
    }
    ...
    */
    public function update_state($values,$where)
    {
        return $this->update_("state",$values,$where);
    }    
    ...
    *                       "name='Joe' AND status='boss' OR status='active'";
    */
    public function delete_state($where)
    {
        return $this->delete_("state",$where);
    }    
