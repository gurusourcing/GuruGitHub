...
class Admin_model extends MY_Model
{
    ...
    */
    public function admin_load($condition,$limit=NULL,$offset=NULL,$order_by=NULL)
    {
        $rs=new stdClass();
        if(is_integer($condition))
        {
            $this->db->join("admin_type at","at.id=a.admin_type_id","left");//left join
            $this->db->select('a.*,at.s_type');
            
            $rs=$this->db
                ->get_where("admin a",
                            array("a.id"=>$condition)
                )
                ->row();
    ...
    */
    public function update_admin($values,$where)
    {
        return $this->update_("admin",$values,$where);
    }    
    ...
    */
    ...
    {
        return $this->delete_("admin",$where);
    }    
