...
$(document).ready(function(){
    ...
    $("#zip").inedit({
       ...
       "sections" : {
            0 : {
                "fieldContainer" : "#s_zip_cont",
                "contentContainer" : "#s_zip_lbl",
                "defaultValues" : $.parseJSON('<?=$default_value[0];?>'),
                "ajaxSaveUrl"   : "<?=admin_base_url("zip/ajax_operation");?>",  
                ...
                "beforeHideCallback" : function(contentContainer,values){
                    contentContainer.html(values["s_zip"]+"("+values["city_id"]+', '+values["state_id"]+', '+values["country_id"]+")");
                },
    ...
    <div id="accountlist">
        <div id="zip">
            <ul class="name_list edit_form">
                <li>
                <span>Zip : </span>
                <div id="s_zip_lbl" class="alignleft"></div>
                <div id="s_zip_cont" class="edit_section">
                      <input id="form_token" name="form_token" type="hidden" value="">
                      <input id="action" name="action" type="hidden" value=""> 
                      <input id="s_zip" name="s_zip" type="text" value="" /> 
...
<div id="zip" class="widget fluid">
    <div class="formRow">
        <div class="grid3"><label>Zip:</label></div>
        <div id="s_zip_lbl" class="grid3"></div>
        <div id="s_zip_cont" class="grid9">
              <input id="form_token" name="form_token" type="hidden" value="">
              <input id="action" name="action" type="hidden" value="">  
              <input id="s_zip" name="s_zip" type="text" value="" size="15" />
              <label>Longitude: </label>
                      <input id="s_longitude" name="s_longitude" type="text" value="" />
                      <label>Latitude: </label>
                      <input id="s_latitude" name="s_latitude" type="text" value="" />
