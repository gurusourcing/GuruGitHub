...
<div class="tablePars">
    <div class="dataTables_filter" id="DataTables_Table_0_filter">
        ...
        <label>Zip: <input type="text" id="s_zip" name="s_zip" value="<?=@$posted["s_zip"];?>"  aria-controls="DataTables_Table_0">
    ...
    <div id="accountlist">
        <div>
            <form id="filter" action="" method="post">
                ...
                <label>Zip : </label> <input id="s_zip" name="s_zip" value="<?=@$posted["s_zip"];?>">
