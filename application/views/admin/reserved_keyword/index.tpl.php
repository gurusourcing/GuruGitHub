...
<div class="tablePars">
    <div class="dataTables_filter" id="DataTables_Table_0_filter">
        ...
        <label>Reserved_keyword: <input type="text" id="s_keyword" name="s_keyword" value="<?=@$posted["s_keyword"];?>"  aria-controls="DataTables_Table_0">
        ...
        <div>
            ...
            <div class="widget fluid">
                <div class="formRow">
                    ...
                    <div class="grid9"><input type="text" id="s_keyword" name="s_keyword" value="<?=@$posted["s_keyword"];?>"></div>
                </div>
                <div class="formRow">
                <input type="submit" name="submit" value="Submit">&nbsp;<input type="reset" name="reset" value="Reset">
                &nbsp;<input type="submit" name="all" value="Show All">
