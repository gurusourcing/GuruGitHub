...
$(document).ready(function(){
    ...
    $('input[id="i_active"]').each(function(){
        $(this).change(function(){
            $.post('<?=admin_base_url('user_company/ajax_changeStatus')?>',
            {"id":{ 0: $(this).attr("value") }},
            function(data){
               window.location.href='<?= admin_base_url('user_company')?>'; 
           });
        });
    })
...
<div class="tablePars">
    <div class="dataTables_filter" id="DataTables_Table_0_filter">
        ...
        <label>Company : <input type="text" id="s_company" name="s_company" value="<?=@$posted["s_company"];?>"  aria-controls="DataTables_Table_0">
