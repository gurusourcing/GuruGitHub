...
function ajax_operate(paramArr){
    $.ajax({
                type: "POST",
                url: "<?=admin_base_url('user_doc_verification/ajax_status_update');?>",
                data:  paramArr
                }).done(function( msg ) {
                //console.log(msg);
...
<div class="tablePars">
    <div class="dataTables_filter" id="DataTables_Table_0_filter">
        ...
        <label>User Doc verification: <input type="text" id="s_user_doc_verification" name="s_user_doc_verification" value="<?=@$posted["s_user_doc_verification"];?>"  aria-controls="DataTables_Table_0">
