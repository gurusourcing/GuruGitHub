...
<div class="tablePars">
    <div class="dataTables_filter" id="DataTables_Table_0_filter">
        ...
        <label>City: <input type="text" id="s_city" name="s_city" value="<?=@$posted["s_city"];?>"  aria-controls="DataTables_Table_0">
    ...
    <div id="accountlist">
        <div>
            <form id="filter" action="" method="post">
                ...
                <label>City : </label> <input id="s_city" name="s_city" value="<?=@$posted["s_city"];?>">
