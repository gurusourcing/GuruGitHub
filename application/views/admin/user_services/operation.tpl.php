...
$(document).ready(function(){
    ...
    $("#user_services").inedit({
        //no need to put the save and cancel buttons//
       "globalSaveResetButton": true,
       "sections" : {
            0 : {
                "fieldContainer" : "#s_user_services_cont",
                "contentContainer" : "#s_user_services_lbl",
                "defaultValues" : $.parseJSON('<?=$default_value[0];?>'),
                "ajaxSaveUrl"   : "<?=admin_base_url("user_services/ajax_operation");?>",
...
*/ ?>
<? dd_document_type() ?>
<div id="user_services" class="widget fluid">
    <div class="formRow">
        <div id="s_user_services_lbl" class="grid3"></div>
        <div id="s_user_services_cont" class="grid9">
              <input id="form_token" name="form_token" type="hidden" value="">
              <input id="action" name="action" type="hidden" value="">  
