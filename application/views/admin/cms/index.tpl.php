...
<div class="tablePars">
    <div class="dataTables_filter" id="DataTables_Table_0_filter">
        ...
        <label>Cms: <input type="text" id="s_cms" name="s_cms" value="<?=@$posted["s_cms"];?>"  aria-controls="DataTables_Table_0">
        ...
        <div>
            ...
            <div class="widget fluid">
                <div class="formRow">
                    ...
                    <div class="grid9"><input type="text" id="s_cms" name="s_cms" value="<?=@$posted["s_cms"];?>"></div>
                </div>
                <div class="formRow">
                <input type="submit" name="submit" value="Submit">&nbsp;<input type="reset" name="reset" value="Reset">
                &nbsp;<input type="submit" name="all" value="Show All">
