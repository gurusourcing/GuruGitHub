...
$(document).ready(function(){
    ...
    $("#featured_services").inedit({
        //no need to put the save and cancel buttons//
       "globalSaveResetButton": true,
       "sections" : {
            0 : {
                "fieldContainer" : "#s_featured_services_cont",
                "contentContainer" : "#s_featured_services_lbl",
                "defaultValues" : $.parseJSON('<?=$default_value[0];?>'),
                "ajaxSaveUrl"   : "<?=admin_base_url("featured_services/ajax_operation");?>",
...
*/ ?>
<? //dd_document_type() ?>
<div id="featured_services" class="widget fluid">
    <div class="formRow">
        <div class="grid3"><label>Featured services:</label></div>
        <div id="s_featured_services_lbl" class="grid3"></div>
        <div id="s_featured_services_cont" class="grid9">
              <input id="form_token" name="form_token" type="hidden" value="">
              <input id="action" name="action" type="hidden" value="">  
              ...
              <input id="action" name="action" type="hidden" value="">  
                  ...
                  <div class="grid4"><input type="text" name="i_price" id="i_price" value=""></div>
                  </div>
                  <div class="formRow">
