...
///common share Box///
?>
<div id="dialog-share"  rel="<?=$form_token;?>" style="display: block;" title="Share with Friend">
...
{
?>
<a href="javascript:void(0);" id="share"  rel="<?=$form_token;?>"><img src="<?=get_theme_path('guru_frontend')?>images/icon11.png" width="18" height="12" alt="icon" /></a>
<?php     
}
?>